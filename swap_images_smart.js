...
replaceImg('index.html', 'class="hero-bg-img parallax-img"\n      src="assets/images/IMG-20260821-WA0034.jpg"', 'IMG-20260821-WA0037.jpg');
...
replaceImg('ooty.html', 'assets/images/IMG-20260821-WA0034.jpg" alt="Ooty Botanical Garden"', 'IMG-20260821-WA0039.jpg');
replaceImg('js/config.js', 'assets/images/IMG-20260821-WA0034.jpg\',\n    category: \'Garden\'', 'IMG-20260821-WA0039.jpg\',\n    category: \'Garden\''); // wait, in config it's WA0034

// 4. Tea Estate Walk -> WA0034 (Day A-Frame landscape is better than Night String lights for a walk)
replaceImg('experiences.html', 'assets/images/IMG-20260821-WA0037.jpg" alt="Tea estate walk"', 'IMG-20260821-WA0034.jpg');
replaceImg('js/config.js', 'assets/images/IMG-20260821-WA0037.jpg\',\n    category: \'Nature\'', 'IMG-20260821-WA0034.jpg\',\n    category: \'Nature\'');

// 5. Property night at The Groot -> WA0037 (Night String lights) - already WA0037
// 6. Luxurious Suite -> WA0038 (Suite interior)
replaceImg('booking.html', 'assets/images/IMG-20260821-WA0037.jpg" alt="Luxurious Suite"', 'IMG-20260821-WA0038.jpg');

// 7. Ooty Lake -> WA0039 (Landscape Day)
replaceImg('js/config.js', 'assets/images/IMG-20260821-WA0039.jpg\',\n    category: \'Lake\'', 'IMG-20260821-WA0034.jpg\',\n    category: \'Lake\'');
replaceImg('experiences.html', 'assets/images/IMG-20260821-WA0034.jpg" alt="Ooty lake and town"', 'IMG-20260821-WA0039.jpg');
...
files.forEach(f => {
  if (fileContents[f]) {
    ...
    c = c.replace(/IMG-20260821-WA0034\.jpg" alt="Luxurious Suite"/, 'IMG-20260821-WA0038.jpg" alt="Luxurious Suite"');
    
    // "Property night" got WA0034 (Day). Let's change to WA0036 (Night campfire)
    c = c.replace(/IMG-20260821-WA0034\.jpg" alt="Property night at The Groot"/, 'IMG-20260821-WA0036.jpg" alt="Property night at The Groot"');
    c = c.replace(/IMG-20260821-WA0034\.jpg at night',(\s*)category: 'property'/g, 'IMG-20260821-WA0036.jpg at night\',$1category: \'property\'');
